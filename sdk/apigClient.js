...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://6h58168vb0.execute-api.us-east-1.amazonaws.com/S1';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'objectKey', 'labels', 'realcontenttype'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'labels', 'realcontenttype']),
